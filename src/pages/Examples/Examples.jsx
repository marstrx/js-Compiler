...
function Examples() {
  ...
  return (
    <div className="mr-5.5 ml-5.5 font-mono mb-30 my-30">
      <h3 className="relative after:content-[''] after:block after:w-30 after:h-[3px] after:bg-blue-500 after:absolute after:left-0 after:-bottom-1">
        Examples
      </h3>
      ...
      {examples.map((ex, i) => (
        <div key={i}>
          ...
          <p>HTML</p>
          <button
            className="mb-30 bg-blue-400 px-7 rounded"
            onClick={() => copyToClipboard(ex.html)}
          >
          ...
          <p>CSS</p>
          <button
            className="bg-blue-400 px-7 rounded"
            onClick={() => copyToClipboard(ex.css)}
          >
            <i className="bi bi-copy"></i> Copy
          </button>
          <pre className="bg-gray-200 rounded p-4 overflow-x-auto mt-3">
