    ...
    <header className="bg-zinc-500 text-white fixed w-full top-0 left-0 shadow-md z-50 font-mono">
      <div className="flex justify-between items-center px-4 py-3">
        ...
        <ul className="hidden md:flex items-center gap-6 text-md font-medium">
          <li>
            <Link style={{textDecoration:"none"}} to="/" className="no-underline text-white" >
              Home
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link style={{textDecoration:"none"}} to="/examples" className=" text-white">
              Examples
            </Link>
          </li>
        </ul>
      ...
      {isOpen && (
        <ul className="md:hidden flex flex-col items-center px-6 pb-4 gap-3 text-md font-medium">
          <li>
            <Link style={{textDecoration:"none"}} to="/" onClick={() => setIsOpen(false)} className="no-underline text-white">
              Home
            </Link>
          </li>
          <li>
            <Link style={{textDecoration:"none"}} to="/docs" onClick={() => setIsOpen(false)} className="no-underline text-white">
              Docs
            </Link>
          </li>
          <li>
            <Link style={{textDecoration:"none"}} to="/examples" onClick={() => setIsOpen(false)} className="no-underline text-white">
              Examples
            </Link>
          </li>
        </ul>
